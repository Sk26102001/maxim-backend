...
export const generateETicketPDF = async (passengerId) => {
    ...
    try {
        ...
        const url = `${process.env.FRONTEND_URL}/e-ticket?pid=${passengerId}&pdf=true`
...
export const generateInvoicePDF = async (passengerId) => {
    ...
    try {
        ...
        const url = `${process.env.FRONTEND_URL}/invoice?pid=${passengerId}&pdf=true`
...
export const generateAccountStatementPDF = async (agentId) => {
    let browser = null
    try {
        const url = `${process.env.FRONTEND_URL}/pdf-list/account-statement/${agentId}`
